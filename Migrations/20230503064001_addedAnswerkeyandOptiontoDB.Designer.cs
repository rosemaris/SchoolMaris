...
namespace SchoolMaris.Migrations
{
    ...
    [Migration("20230503064001_addedAnswerkeyandOptiontoDB")]
    partial class addedAnswerkeyandOptiontoDB
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SchoolMaris.Model.AnswerKey", b =>
                {
            ...
            modelBuilder.Entity("SchoolMaris.Model.Credentials", b =>
                {
            ...
            modelBuilder.Entity("SchoolMaris.Model.EnrolmentProfile", b =>
                {
                    b.Property<int>("EnrolmentProfileID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.HasKey("EnrolmentProfileID");

                    b.HasIndex("LevelSubjectTeacherID");

                    b.HasIndex("PupilsProfileID");

                    b.ToTable("EnrolmentProfile");
                });
            ...
            modelBuilder.Entity("SchoolMaris.Model.Option", b =>
                {
            ...
            modelBuilder.Entity("SchoolMaris.Model.EnrolmentProfile", b =>
                {
                    b.HasOne("SchoolMaris.Model.LevelSubjectTeacher", "LevelSubjectTeacher")
                        .WithMany("EnrolmentProfiles")
                        .HasForeignKey("LevelSubjectTeacherID")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("SchoolMaris.Model.PupilsProfile", "PupilsProfile")
                        .WithMany("EnrolmentProfiles")
                        .HasForeignKey("PupilsProfileID")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
                });
